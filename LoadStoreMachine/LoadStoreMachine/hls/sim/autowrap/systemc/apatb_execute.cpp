...
#define AUTOTB_TVOUT_opcode "../tv/cdatafile/c.execute.autotvout_opcode.dat"
#define AUTOTB_TVIN_ra_addr "../tv/cdatafile/c.execute.autotvin_ra_addr.dat"
#define AUTOTB_TVOUT_ra_addr "../tv/cdatafile/c.execute.autotvout_ra_addr.dat"
#define AUTOTB_TVIN_rb_addr "../tv/cdatafile/c.execute.autotvin_rb_addr.dat"
#define AUTOTB_TVOUT_rb_addr "../tv/cdatafile/c.execute.autotvout_rb_addr.dat"
#define AUTOTB_TVIN_rc_addr "../tv/cdatafile/c.execute.autotvin_rc_addr.dat"
#define AUTOTB_TVOUT_rc_addr "../tv/cdatafile/c.execute.autotvout_rc_addr.dat"
#define AUTOTB_TVIN_imd_data "../tv/cdatafile/c.execute.autotvin_imd_data.dat"
#define AUTOTB_TVOUT_imd_data "../tv/cdatafile/c.execute.autotvout_imd_data.dat"
#define AUTOTB_TVOUT_return "../tv/cdatafile/c.execute.autotvout_ap_return.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_return "../tv/rtldatafile/rtl.execute.autotvout_ap_return.dat"
...
extern "C"
void execute_hw_stub_wrapper(hls::sim::Byte<4>*, hls::sim::Byte<1>*, hls::sim::Byte<1>*, hls::sim::Byte<1>*, hls::sim::Byte<1>*, hls::sim::Byte<4>*);

extern "C"
void apatb_execute_hw(hls::sim::Byte<4>* ap_return, hls::sim::Byte<1>* __xlx_apatb_param_opcode, hls::sim::Byte<1>* __xlx_apatb_param_ra_addr, hls::sim::Byte<1>* __xlx_apatb_param_rb_addr, hls::sim::Byte<1>* __xlx_apatb_param_rc_addr, hls::sim::Byte<4>* __xlx_apatb_param_imd_data)
{
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_opcode),
#endif
  };
  port1.param = __xlx_apatb_param_opcode;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_ra_addr),
#endif
  };
  port2.param = __xlx_apatb_param_ra_addr;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_rb_addr),
#endif
  };
  port3.param = __xlx_apatb_param_rb_addr;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_rc_addr),
#endif
  };
  port4.param = __xlx_apatb_param_rc_addr;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_imd_data),
#endif
  };
  port5.param = __xlx_apatb_param_imd_data;
  ...
  try {
    ...
    execute_hw_stub_wrapper(ap_return, __xlx_apatb_param_opcode, __xlx_apatb_param_ra_addr, __xlx_apatb_param_rb_addr, __xlx_apatb_param_rc_addr, __xlx_apatb_param_imd_data);
