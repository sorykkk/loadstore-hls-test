...
HLS_SOURCES = ../../../../test_lsm.cpp ../../../../loadstore.cpp
...
$(ObjDir)/test_lsm.o: ../../../../test_lsm.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../test_lsm.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/test_lsm.d

$(ObjDir)/loadstore.o: ../../../../loadstore.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../loadstore.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/loadstore.d
