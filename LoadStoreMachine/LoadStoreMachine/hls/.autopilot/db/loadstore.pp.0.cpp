...
__attribute__((sdx_kernel("execute", 0))) data_t execute(
    opcode_t opcode,
    reg_t ra_addr,
    reg_t rb_addr,
    reg_t rc_addr,
...
#pragma pack(pop)
# 10 "C:/Xilinx/2025.1/Vitis/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\stdio.h" 2 3
...
# 506 "C:/Xilinx/2025.1/Vitis/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\stdio.h" 3
...
# 761 "C:/Xilinx/2025.1/Vitis/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\stdio.h" 3
#pragma GCC diagnostic push
#pragma GCC diagnostic ignored "-Wshadow"
...
# 1061 "C:/Xilinx/2025.1/Vitis/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\stdio.h" 3
...
# 1200 "C:/Xilinx/2025.1/Vitis/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\stdio.h" 3
...
#pragma HLS INLINE
 VITIS_LOOP_6_1: for(int i = 0; i < 32; i++)
        registers[i] = 0;
}
...
void RegisterFile::reset() {
    VITIS_LOOP_23_1: for(int i = 0; i < 32; i++)
        registers[i] = 0;
}
...
Memory::Memory() {
#pragma HLS INLINE
 VITIS_LOOP_83_1: for(int i = 0; i < 1024; i++)
        memory[i] = 0;
}
...
void Memory::reset() {
    VITIS_LOOP_98_1: for(int i = 0; i < 1024; i++)
        memory[i] = 0;
}
...
void LSM::print_registers() {
    VITIS_LOOP_160_1: for(int i = 0; i < 32; i++) {
        if(i%4 == 0) {
            printf("\n$%02d: ", i);
        }
...
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=execute
# 185 "loadstore.cpp"
