...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "execute.autotvin.dat"
	set constFileTvOut       "execute.autotvout.dat"
	set constFileHdlTvIn     "execute.autohdltvin.dat"
	set constFileHdlTvOut    "execute.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
