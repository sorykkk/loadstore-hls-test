...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.execute.autotvin_opcode.dat"
         "c.execute.autotvin_ra_addr.dat"
         "c.execute.autotvin_rb_addr.dat"
         "c.execute.autotvin_rc_addr.dat"
         "c.execute.autotvin_imd_data.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.execute.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
